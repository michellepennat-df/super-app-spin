...
import UsedMovementsList from './Used';


describe('Used Movement List', () => {

    beforeEach(() => {
        render(renderWithNavigator(renderWithTheme(<UsedMovementsList />)))
    })

    it('renders correctly', () => {
        const listItem = screen.getByTestId('used-movements-list')
